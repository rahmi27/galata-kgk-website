...
export function QuizRunner({ questions, initialScore, initialAnswered, totalQuestions, locale }: { questions: Question[]; initialScore: number; initialAnswered: number; totalQuestions: number; locale: string }) {
