...
export default async function BadgePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <main className="mx-auto max-w-2xl px-5 py-14 sm:py-20"><BadgeDownload participantName={participant.fullName} eventTitle={participant.eventSession.title} locale={locale} /></main>;
}
