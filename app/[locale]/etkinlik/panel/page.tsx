...
export default async function EventHubPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const cards = [
    ...
    session.pollEnabled && { title: en ? "Join the Poll 🗳️" : "Ankete Katıl 🗳️", description: en ? "Cast your vote and watch the live poll results." : "Oyunu kullan, canlı anket sonuçlarını takip et.", href: "/etkinlik/panel/anket" as const, icon: BarChart3, locked: false },
